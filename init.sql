...
DROP TABLE IF EXISTS public.notes, public.node_aliases CASCADE;
DROP INDEX IF EXISTS note_aliases_note_id_index;
DROP INDEX IF EXISTS note_aliases_name_index;
...
CREATE INDEX notes_file_path_index ON public.notes (file_path);
